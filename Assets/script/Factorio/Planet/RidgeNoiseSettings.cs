...
public class RidgeNoiseSettings {
    ...
    public void SetParameter(int numLayers, float lacunarity, float persistence, float scale, float power, float elevation, float gain, float verticalShift, float peakSmoothing) {
